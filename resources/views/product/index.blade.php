...
@section('title', 'MPR | List Product')

@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h1 class="p-0">Product</h1>
            <div class="card">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-sm btn-avian-primary btn-add" data-toggle="modal" data-target="#addModal">
                                <i class="fas fa-plus mr-2"></i>Add<span class="d-none d-lg-inline"> Product</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="dataTable table table-striped table-hover table-bordered w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle" data-priority="3">Kode</th>
...
<div class="modal fade" id="addModal" data-backdrop="static" data-keyboard="false" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form id="formItem" class="modal-content" method="post" action="{{ route('product.store') }}" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control select2-tags" id="satuan" name="satuan">
...
@section('js')
<script>
    var baseurl = "{{route('product.datatable')}}";
    ...
    $('.btn-add').on('click', function (e) {
        ...
        $('#formItem').attr('action', "{{ route('product.store') }}");
    ...
    $('.dataTable').on('click', '.btn-edit', function (e) {
        ...
        $('#formItem #satuan').val(data.Satuan).trigger('change');
        $('#formItem #kode').val(data.Kode);
        $('#addModalLabel').text('Edit Product');
        $('#addModal').modal('show');
        $('#formItem').attr('action', "{{ route('product.update', '@id') }}".replace('@id', data.ProductID));
        $('#formItem').attr('method', 'POST');
        $('#formItem').find('input[name="_method"]').remove();
