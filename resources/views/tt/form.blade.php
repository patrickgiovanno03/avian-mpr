                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-6 order-1 order-md-2" id="form-container">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea rows="3" class="form-control" id="Notes" name="Notes">{{ $tt->Notes ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        getFormDetails(val, type, function(form, total) {
            if (form) {
                if (type === 'invoice') {
                    ...
                    $row.find('input[name="date[]"]').val(form.InvoiceDate != null ? moment(form.InvoiceDate).format('DD/MM/YYYY') : '');
