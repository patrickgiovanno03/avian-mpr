...
function get_translate_j() = in_string(text[0], "J") ? 1 : 0;
function get_rotate_j() = in_string(text[0], "J") ? 20 : 0;
/* ========================================================= */
/* ===================== RENDER ============================ */
/* ========================================================= */
...
translate([-1*get_translate_j(),get_translate_j(),0])
rotate([0,0,-get_rotate_j()])
    difference() {
